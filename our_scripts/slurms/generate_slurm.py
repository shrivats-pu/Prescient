# generate_slurm.py: should make it easier to put together more complicated slurm jobs
# created by: Ethan Reese
# email: ereese@princeton.edu
# June 25, 2021

path = "/scratch/gpfs/ereese/big_run_ideal/Prescient/our_scripts/parallel_versions"
...
preface = ["#!/bin/bash\n",
"#SBATCH --job-name=Parallel_ideal    # create a short name for your job \n",
"#SBATCH --nodes=1                # node count\n",
"#SBATCH --ntasks=75               # how many instances of your command are run, total, across all nodes\n",
...
file = open("parallel_ideal.slurm", "w")
file.writelines(preface)

for asset in assets:
        file.write("srun --exclusive -N 1 -n 1 python parallel_ideal.py " + asset + " &\n")
